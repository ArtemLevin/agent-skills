...
from .graphify import ensure_graphify_ignore, install_graphify_project_skill
...
def initialize_project(
    ...
    *,
    ...
    graphify_ignore_changed = ensure_graphify_ignore(project_root)
    ...
    return {
        ...
        "graphify_ignore": str(project_root / ".graphifyignore"),
        "graphify_ignore_changed": graphify_ignore_changed,
